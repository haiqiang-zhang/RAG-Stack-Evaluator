"""Override the metric set without changing the resolved pipeline."""
...
def main() -> None:
    ...
    project_dir = prepare_project(args.work_dir, prefix="metrics")
    evaluator = build_evaluator(project_dir)
    quality = evaluator.evaluate(
        resolved_pipeline_config(),
        run_dir=str(project_dir / "runs" / "metrics-override"),
        metrics_override=["retrieval_token_f1"],
    )
