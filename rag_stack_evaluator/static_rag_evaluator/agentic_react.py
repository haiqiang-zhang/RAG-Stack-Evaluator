...
(:class:`~rag_stack_evaluator.static_rag_evaluator.nodes.semanticretrieval.vectordb.VectorDB`)
and generator (:class:`~rag_stack_evaluator.static_rag_evaluator.nodes.generator.vllm.Vllm`)
...
``rag_stack_evaluator.static_rag_evaluator.measured.serving_runtime``. This module is the
