...
from rag_stack_evaluator.static_rag_evaluator.support import dynamically_find_function
from rag_stack_evaluator.static_rag_evaluator.utils.util import load_yaml_config
...
SUPPORT_VECTORDB = {
	"chroma": ("rag_stack_evaluator.static_rag_evaluator.vectordb.chroma", "Chroma"),
	"Chroma": ("rag_stack_evaluator.static_rag_evaluator.vectordb.chroma", "Chroma"),
	"milvus": ("rag_stack_evaluator.static_rag_evaluator.vectordb.milvus", "Milvus"),
	"Milvus": ("rag_stack_evaluator.static_rag_evaluator.vectordb.milvus", "Milvus"),
	"weaviate": ("rag_stack_evaluator.static_rag_evaluator.vectordb.weaviate", "Weaviate"),
	"Weaviate": ("rag_stack_evaluator.static_rag_evaluator.vectordb.weaviate", "Weaviate"),
	"pinecone": ("rag_stack_evaluator.static_rag_evaluator.vectordb.pinecone", "Pinecone"),
	"Pinecone": ("rag_stack_evaluator.static_rag_evaluator.vectordb.pinecone", "Pinecone"),
	"couchbase": ("rag_stack_evaluator.static_rag_evaluator.vectordb.couchbase", "Couchbase"),
	"Couchbase": ("rag_stack_evaluator.static_rag_evaluator.vectordb.couchbase", "Couchbase"),
	"qdrant": ("rag_stack_evaluator.static_rag_evaluator.vectordb.qdrant", "Qdrant"),
	"Qdrant": ("rag_stack_evaluator.static_rag_evaluator.vectordb.qdrant", "Qdrant"),
	"faiss_ivf": ("rag_stack_evaluator.static_rag_evaluator.vectordb.faiss_ivf", "FaissIVF"),
	"FaissIVF": ("rag_stack_evaluator.static_rag_evaluator.vectordb.faiss_ivf", "FaissIVF"),
	"faiss_hnsw": ("rag_stack_evaluator.static_rag_evaluator.vectordb.faiss_hnsw", "FaissHNSW"),
	"FaissHNSW": ("rag_stack_evaluator.static_rag_evaluator.vectordb.faiss_hnsw", "FaissHNSW"),
}
