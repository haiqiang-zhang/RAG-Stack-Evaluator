...
Usage:
    from rag_stack_evaluator.static_rag_evaluator.nodes.generator.registry import (
        get_generator_class,
...
GENERATOR_BACKENDS: dict[str, Any] = {
    ...
    "openai_llm": ("rag_stack_evaluator.static_rag_evaluator.nodes.generator.openai_llm", "OpenAILLM"),
    "vllm": ("rag_stack_evaluator.static_rag_evaluator.nodes.generator.vllm", "Vllm"),
    "vllm_api": ("rag_stack_evaluator.static_rag_evaluator.nodes.generator.vllm_api", "VllmAPI"),
...
try:
    from rag_stack_evaluator.static_rag_evaluator.nodes.generator.llama_index_vllm_adapter import (
        LlamaIndexVllm,
    )
