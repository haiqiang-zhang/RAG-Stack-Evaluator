...
from rag_stack_evaluator.static_rag_evaluator.evaluation.util import cast_metrics
from rag_stack_evaluator.static_rag_evaluator.node_line import run_node_line
from rag_stack_evaluator.static_rag_evaluator.trace_builder import (
	build_static_execution_dag,
	build_static_fanout_dag,
	rag_ir_dynamic_enabled,
)
from rag_stack_evaluator.static_rag_evaluator.nodes.lexicalretrieval.bm25 import bm25_ingest
from rag_stack_evaluator.static_rag_evaluator.nodes.retrieval.base import get_bm25_pkl_name
...
from rag_stack_evaluator.static_rag_evaluator.schema.node import (
	module_type_exists,
...
from rag_stack_evaluator.static_rag_evaluator.vectordb import load_vectordb
...
class StaticRAGEvaluatorQualityOnly(BaseEvaluator):
	...
	def evaluate(
		...
		:class:`rag_stack_evaluator.static_rag_evaluator.measured.evaluator.MeasuredEvaluator`,
	...
	def _sweep_stale_gpu_engines() -> None:
		...
		gc.collect()
		try:
			from rag_stack_evaluator.static_rag_evaluator.engine_slot import quality_engine_slot
			from rag_stack_evaluator.static_rag_evaluator.nodes.generator.vllm import (
		...
		*,
		...
		try:
			...
			if evaluation_config.get("performance_only"):
				...
				from rag_stack_evaluator.static_rag_evaluator import gen_fingerprint as _gfp
	...
	def _run_react(self, config, node_lines, vectordb_configs):
		...
		from rag_stack_evaluator.static_rag_evaluator.nodes.semanticretrieval.vectordb import VectorDB
