...
from rag_stack.static_rag_evaluator.measured.vllm_pd_pair import VllmPdPairKey
...
class VllmDeploymentManager:
    ...
    def prepare_trial(
        ...
        *,
        ...
        from rag_stack.static_rag_evaluator.measured.gpu_mem import _free_total_gib
