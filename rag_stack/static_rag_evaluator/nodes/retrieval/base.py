...
from rag_stack.static_rag_evaluator.support import get_support_modules
from rag_stack.utils.preprocess import validate_qa_dataset
from rag_stack.static_rag_evaluator.utils import fetch_contents, result_to_dataframe
...
class BaseRetrieval(BaseModule, metaclass=abc.ABCMeta):
	def __init__(self, project_dir: str, *args, **kwargs):
		...
		if shared_corpus is not None:
			...
			return
		from rag_stack.static_rag_evaluator.dataset import get_active_corpus
